...
public class HibernateCriteria {
    public static void main(String[] args) {
        ...
        clientes = em.createQuery(query).setParameter("nombre", "Daniel").getResultList();
        clientes.forEach(System.out::println);
        ...
        clientes = em.createQuery(query).setParameter("nombreParam", "%na%")
                .getResultList();
        clientes.forEach(System.out::println);
        ...
        clientes = em.createQuery(query)
                .setParameter("nombres", Arrays.asList("Daniel", "Luisina", "Lulu"))
                .getResultList();
        clientes.forEach(System.out::println);
        ...
        from = queryObject.from(Cliente.class);
        queryObject.multiselect(from.get("id"), from.get("nombre"), from.get("apellido")).where(criteria.like(from.get("nombre"), "%na%"));
