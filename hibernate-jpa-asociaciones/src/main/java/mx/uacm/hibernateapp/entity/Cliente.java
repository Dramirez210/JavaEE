package mx.uacm.hibernateapp.entity;
...
public class Cliente {
    ...
    @OneToMany(cascade = CascadeType.ALL, orphanRemoval = true) // cada que se crea un cliente se crea direcciones
    //@JoinColumn(name = "id_cliente")
    @JoinTable(name = "tbl_clientes_direcciones", joinColumns = @JoinColumn(name="id_cliente") //id a repetir
    , inverseJoinColumns = @JoinColumn(name = "id_direccion")
    , uniqueConstraints = @UniqueConstraint(columnNames={"id_direccion"})) //id unico
    private List<Direccion> direcciones;

    @OneToMany(cascade = CascadeType.ALL, orphanRemoval = true, mappedBy = "cliente") //mapped atributo de la contraparte
